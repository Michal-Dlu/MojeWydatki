    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div  id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="{{route('customers.form')}}">Wyczyść formularz</a></li>
        ...
        <section class="masthead page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Edytujesz Użytkownika: {{$customer->name}}</h2>
                <!-- Icon Divider-->
